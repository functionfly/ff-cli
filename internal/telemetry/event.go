...
// the CLI, runtime, and compiler. It is intentionally dependency-free so
// that operators can back it with logrus, OpenTelemetry, or a no-op sink.
package telemetry
...
const (
	...
	EventLocalExecEnd   EventKind = "local_exec_end"
